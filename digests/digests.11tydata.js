...
// (NOT subfolders — `weekly/` and `monthly/` have their own data files
// that fully override these settings). Parses date / permalink / title
// from the filename pattern: YYYY-MM-DD_HHMM_tech-news.md
